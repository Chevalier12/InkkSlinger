...
public sealed class InkkOopsPointerUpTargetCommand : IInkkOopsCommand
{
    public InkkOopsPointerUpTargetCommand(InkkOopsTargetReference target, InkkOopsPointerAnchor? anchor = null, MouseButton button = MouseButton.Left, InkkOopsPointerMotion? motion = null)
    {
    ...
    {
        return $"PointerUp({Target}, anchor: {Anchor}, button: {Button}, travelFrames: {Motion.TravelFrames}, easing: {Motion.Easing})";
    }
