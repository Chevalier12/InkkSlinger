...
internal readonly record struct RetainedRenderControllerTelemetrySnapshot(
    ...
    int ContentInvalidationCount,
    int TransformInvalidationCount,
    int ClipInvalidationCount,
    int OpacityInvalidationCount,
    int VisibilityInvalidationCount,
    int EffectInvalidationCount,
    int StructureTypedInvalidationCount,
    int BoundsInvalidationCount,
    int OverlayInvalidationCount,
    int DeviceResourceInvalidationCount,
    string LastInvalidationKind,
    string LastInvalidationSource,
    int CompositionMetadataUpdateCount,
    int TransformMetadataUpdateCount,
    int ClipMetadataUpdateCount,
    int OpacityMetadataUpdateCount,
    int VisibilityMetadataUpdateCount,
    int CompositionMetadataUpdateMissCount,
    string LastCompositionMetadataUpdateKind,
    string LastCompositionMetadataUpdateSource,
    int CompositionNodeCount,
    int RetainedToCompositionNodeCountDelta,
    int CompositionRebuildCount,
    double LastCompositionSyncBuildMilliseconds,
    int VisualRecordCount,
    int VisualRecordRebuildCount,
    int VisualRecordReuseCount,
    int LastVisualRecordCommandCount,
    string LastRecordedVisualType,
    string LastRecordedVisualName,
    int CommandReplayCount,
    int CommandReplayFallbackCount,
    int UnsupportedCommandFallbackCount,
    int LastCompositionRecordPassCount,
    int LastCompositionMetadataPassCount,
    int LastCompositionFullPassCount,
    string LastCompositionPrimaryMode,
    string LastCompositionPrimaryReason,
    int CompositorOnlyFrameCount,
    int FullCompositionFrameCount,
    int CompositionSubtreeCullCount,
    int CompositionSelfCullCount,
    int CompositionTransformPushCount,
    int CompositionOpacityPushCount,
    int CacheModeBoundaryCount,
    int BitmapCacheBoundaryCount,
    int DeferredBitmapCacheBoundaryCount,
    double CompositionCullingMilliseconds,
    double CompositionCommandReplayMilliseconds);
