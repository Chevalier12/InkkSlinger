...
internal readonly record struct GridTelemetrySnapshot(
    ...
    long MeasureChildMissNeedsMeasureCount,
    long MeasureChildMissInvalidCacheCount,
    long MeasureChildMissReuseRejectedCount,
    string MeasureChildNeedHottestPath,
    double MeasureChildNeedHottestMilliseconds,
    string MeasureChildRejectHottestPath,
    double MeasureChildRejectHottestMilliseconds,
