...
public sealed partial class UiRoot
{
    ...
    {
        private UIElement _visualRoot => _root._visualRoot;
        private UiRootVisualIndex _visualIndex => _root._visualIndex;
        private List<RenderNode> _retainedRenderList => RetainedRenderList;
        private Dictionary<UIElement, int> _renderNodeIndices => RenderNodeIndices;
        private Queue<UIElement> _dirtyRenderQueue => DirtyRenderQueue;
        private HashSet<UIElement> _dirtyRenderSet => DirtyRenderSet;
        private HashSet<UIElement> _dirtyRenderRootsRequireDeepSync => DirtyRenderRootsRequireDeepSync;
        private HashSet<UIElement> _dirtyRenderRootsAllowSubtreeRebuild => DirtyRenderRootsAllowSubtreeRebuild;
        private List<DirtyRenderWorkItem> _dirtyRenderWorkItems => DirtyRenderWorkItems;
        private List<IndexedDirtyRenderCandidate> _dirtyRenderCandidates => DirtyRenderCandidates;
        private List<UIElement> _pendingAncestorMetadataRefreshRoots => PendingAncestorMetadataRefreshRoots;
        private List<UIElement> _ancestorMetadataRefreshBuffer => AncestorMetadataRefreshBuffer;
        private HashSet<UIElement> _ancestorMetadataRefreshSet => AncestorMetadataRefreshSet;
        private List<UIElement> _lastSynchronizedDirtyRenderRoots => LastSynchronizedDirtyRenderRoots;
        private List<UIElement> _lastCompletedSynchronizedDirtyRenderRoots => LastCompletedSynchronizedDirtyRenderRoots;
        ...
        private bool _renderListNeedsFullRebuild { get => _root._renderListNeedsFullRebuild; set => _root._renderListNeedsFullRebuild = value; }
        private int _lastDirtyRootCountAfterCoalescing { get => _root._lastDirtyRootCountAfterCoalescing; set => _root._lastDirtyRootCountAfterCoalescing = value; }
        private double _lastRetainedQueueCompactionMs { get => _root._lastRetainedQueueCompactionMs; set => _root._lastRetainedQueueCompactionMs = value; }
        private double _lastRetainedCandidateCoalescingMs { get => _root._lastRetainedCandidateCoalescingMs; set => _root._lastRetainedCandidateCoalescingMs = value; }
        private int _lastRetainedOverlapForcedDeepCount { get => _root._lastRetainedOverlapForcedDeepCount; set => _root._lastRetainedOverlapForcedDeepCount = value; }
        private int _lastAncestorMetadataRefreshNodeCount { get => _root._lastAncestorMetadataRefreshNodeCount; set => _root._lastAncestorMetadataRefreshNodeCount = value; }
        private int _lastRetainedDirtyVisualCount { get => _root._lastRetainedDirtyVisualCount; set => _root._lastRetainedDirtyVisualCount = value; }
        private bool _lastRetainedSyncUsedFullRebuild { get => _root._lastRetainedSyncUsedFullRebuild; set => _root._lastRetainedSyncUsedFullRebuild = value; }
        private double _lastRetainedSubtreeUpdateMs { get => _root._lastRetainedSubtreeUpdateMs; set => _root._lastRetainedSubtreeUpdateMs = value; }
        private int _retainedSubtreeSyncCount { get => _root._retainedSubtreeSyncCount; set => _root._retainedSubtreeSyncCount = value; }
        private double _lastRetainedAncestorRefreshMs { get => _root._lastRetainedAncestorRefreshMs; set => _root._lastRetainedAncestorRefreshMs = value; }
        private int _retainedFullRebuildCount { get => _root._retainedFullRebuildCount; set => _root._retainedFullRebuildCount = value; }
        private int _visualStructureVersion { get => _root._visualStructureVersion; set => _root._visualStructureVersion = value; }
        private int _lastRetainedForceDeepSyncCount { get => _root._lastRetainedForceDeepSyncCount; set => _root._lastRetainedForceDeepSyncCount = value; }
        private int _lastRetainedForcedDeepDowngradeBlockedCount { get => _root._lastRetainedForcedDeepDowngradeBlockedCount; set => _root._lastRetainedForcedDeepDowngradeBlockedCount = value; }
        private double _lastRetainedDeepSyncMs { get => _root._lastRetainedDeepSyncMs; set => _root._lastRetainedDeepSyncMs = value; }
        private int _lastRetainedShallowRejectStructureCount { get => _root._lastRetainedShallowRejectStructureCount; set => _root._lastRetainedShallowRejectStructureCount = value; }
        private double _lastRetainedShallowSyncMs { get => _root._lastRetainedShallowSyncMs; set => _root._lastRetainedShallowSyncMs = value; }
        private int _lastRetainedShallowRejectVisibilityCount { get => _root._lastRetainedShallowRejectVisibilityCount; set => _root._lastRetainedShallowRejectVisibilityCount = value; }
        private int _lastRetainedShallowRejectRenderStateCount { get => _root._lastRetainedShallowRejectRenderStateCount; set => _root._lastRetainedShallowRejectRenderStateCount = value; }
        private int _lastRetainedShallowSuccessCount { get => _root._lastRetainedShallowSuccessCount; set => _root._lastRetainedShallowSuccessCount = value; }
        private int _lastRetainedNodesVisited { get => _root._lastRetainedNodesVisited; set => _root._lastRetainedNodesVisited = value; }

        private void EnsureVisualIndexCurrent() => _root.EnsureVisualIndexCurrent();
        private void ArmFullRedrawSettleWindowForResize() => _root.ArmFullRedrawSettleWindowForResize();
        private string DescribeElementForDiagnostics(UIElement? element) => element == null ? "none" : UiRoot.DescribeElementForDiagnostics(element);
        internal void SyncDirtyRegionViewport(Viewport viewport)
        {
        ...
        internal bool TryGetIndexedVisualNodeCore(UIElement? element, out UiIndexedVisualNode node)
        {
        ...
        internal void EnqueueDirtyRenderNode(UIElement visual, bool requireDeepSync = false, bool allowSubtreeRebuild = false)
        {
            ...
            if (!_dirtyRenderSet.Add(visual))
            {
                ...
                if (allowSubtreeRebuild)
                {
                    _dirtyRenderRootsAllowSubtreeRebuild.Add(visual);
                }
        ...
        private void CompactDirtyRenderQueueForSync()
        {
            ...
            var subtreeRebuildRoots = _dirtyRenderRootsAllowSubtreeRebuild.Count == 0
                ? null
                : new HashSet<UIElement>(_dirtyRenderRootsAllowSubtreeRebuild);
            _dirtyRenderRootsRequireDeepSync.Clear();
            _dirtyRenderRootsAllowSubtreeRebuild.Clear();
            ...
            if (_dirtyRenderCompactionBuffer.Count == 1 &&
                TryCompactSingleDirtyRenderCandidate(
                    ...
                    subtreeRebuildRoots?.Contains(_dirtyRenderCompactionBuffer[0]) == true))
            {
            ...
            for (var i = 0; i < _dirtyRenderCompactionBuffer.Count; i++)
            {
                ...
                {
                    _dirtyRenderWorkItems.Add(new DirtyRenderWorkItem(candidate, -1, -1, true, false));
                    continue;
                }
                ...
                _dirtyRenderCandidates.Add(new IndexedDirtyRenderCandidate(
                    ...
                    subtreeRebuildRoots?.Contains(candidate) == true));
            }
        ...
        private bool TryCompactSingleDirtyRenderCandidate(
            UIElement candidate,
            bool requiresFullRebuild,
            bool requiresDeepSync,
            bool allowSubtreeRebuild)
        {
            if (!TryGetIndexedVisualNodeCore(candidate, out _))
            {
                return true;
        ...
        private void AddSortedDirtyRenderCandidate(IndexedDirtyRenderCandidate candidate)
        {
            if (_dirtyRenderWorkItems.Count == 0)
            {
                _dirtyRenderWorkItems.Add(new DirtyRenderWorkItem(
                    ...
                    candidate.AllowsSubtreeRebuild));
                return;
            }
                ...
                candidate.RenderNodeIndex < last.SubtreeEndIndexExclusive)
            {
                ...
                _dirtyRenderWorkItems[lastIndex] = last with
                {
                    RequiresDeepSync = last.RequiresDeepSync || candidate.RequiresDeepSync,
                    AllowsSubtreeRebuild = last.AllowsSubtreeRebuild || candidate.AllowsSubtreeRebuild
                };
                return;
            }
        ...
        internal void ClearDirtyRenderQueue()
        {
        ...
        internal void ResetRetainedSyncTrackingState()
        {
        ...
        internal void SynchronizeRetainedRenderList()
        {
            ...
            for (var i = 0; i < _dirtyRenderWorkItems.Count; i++)
            {
                ...
                var allowSubtreeRebuild = dirtyItem.AllowsSubtreeRebuild;
                var updateSubtreeStart = Stopwatch.GetTimestamp();
                UpdateRenderNodeSubtree(dirtyVisual, forceDeepSync, allowSubtreeRebuild, out var ancestorRefreshRoot);
        ...
        internal void RebuildRetainedRenderList()
        {
        ...
        private void UpdateRenderNodeSubtree(
            UIElement dirtySubtreeRoot,
            bool forceDeepSync,
            bool allowSubtreeRebuild,
            out UIElement? ancestorRefreshRoot)
        {
            ...
            if (allowSubtreeRebuild)
            {
                RebuildRetainedSubtreeRange(dirtySubtreeRoot, dirtySubtreeRootIndex);
                if (!_renderListNeedsFullRebuild)
                {
            ...
            var previousTransformScrollDirtyBoundsSuppressionRoot = _transformScrollDirtyBoundsSuppressionRoot;
            if (TryGetTransformScrollDirtyBoundsHint(dirtySubtreeRoot, out _))
            {
                _transformScrollDirtyBoundsSuppressionRoot = dirtySubtreeRoot;
            }
            ...
            {
                _transformScrollDirtyBoundsSuppressionRoot = previousTransformScrollDirtyBoundsSuppressionRoot;
            ...
            RenderNode? parentNodeOverride = null)
        {
            ...
            var replacement = new List<RenderNode>(Math.Max(1, previousRootNode.SubtreeVisualCount));
            _ = BuildRenderSubtreeInto(
                replacement,
                dirtySubtreeRoot,
                dirtySubtreeRootIndex,
                previousRootNode.TraversalOrder,
                previousRootNode.Depth,
                parentNode);

            var oldEndIndexExclusive = previousRootNode.SubtreeEndIndexExclusive;
            var oldCount = oldEndIndexExclusive - dirtySubtreeRootIndex;
            var newCount = replacement.Count;
            var delta = newCount - oldCount;

            _retainedRenderList.RemoveRange(dirtySubtreeRootIndex, oldCount);
            _retainedRenderList.InsertRange(dirtySubtreeRootIndex, replacement);

            if (delta != 0)
            {
                for (var i = 0; i < dirtySubtreeRootIndex; i++)
                {
                    var node = _retainedRenderList[i];
                    if (node.SubtreeEndIndexExclusive >= oldEndIndexExclusive)
                    {
                        _retainedRenderList[i] = node.WithSubtreeEndIndex(node.SubtreeEndIndexExclusive + delta);
                    }
                }

                for (var i = dirtySubtreeRootIndex + newCount; i < _retainedRenderList.Count; i++)
                {
                    var node = _retainedRenderList[i];
                    _retainedRenderList[i] = node.WithTraversalAndSubtreeEnd(
                        node.TraversalOrder + delta,
                        node.SubtreeEndIndexExclusive + delta);
                }
            }

            RebuildRenderNodeIndexMap();
        }

        private int BuildRenderSubtreeInto(
            List<RenderNode> target,
            UIElement visual,
        ...
        {
            var nodeAbsoluteIndex = absoluteStartIndex + target.Count;
            var node = CreateRenderNode(
                visual,
                traversalOrder,
                depth,
                nodeAbsoluteIndex + 1,
            ...
            foreach (var child in visual.GetRetainedRenderChildren())
            {
                var childRootRelativeIndex = target.Count;
                traversalOrder = BuildRenderSubtreeInto(
                    target,
                    child,
                    absoluteStartIndex,
                    traversalOrder,
                ...
                metadata = MergeSubtreeMetadata(
                    metadata,
                    CreateSubtreeMetadataFromSubtreeNode(target[childRootRelativeIndex]));
            }

            var subtreeEndIndexExclusive = absoluteStartIndex + target.Count;
            target[nodeAbsoluteIndex - absoluteStartIndex] = node.WithSubtreeMetadata(
                subtreeEndIndexExclusive,
                metadata.HasBoundsSnapshot,
                metadata.BoundsSnapshot,
                metadata.VisualCount,
        ...
        private void RebuildRenderNodeIndexMap()
        {
            _renderNodeIndices.Clear();
            _renderNodeIndices.EnsureCapacity(_retainedRenderList.Count);
            for (var i = 0; i < _retainedRenderList.Count; i++)
            {
                _renderNodeIndices[_retainedRenderList[i].Visual] = i;
            }
        }
        ...
        private bool TryUpdateRenderNodeSubtreeShallow(UIElement visual, out ShallowSyncRejectReason rejectReason, out bool subtreeMetadataChanged)
        {
            ...
            var previousTransformScrollDirtyBoundsSuppressionRoot = _transformScrollDirtyBoundsSuppressionRoot;
            if (TryGetTransformScrollDirtyBoundsHint(visual, out _))
            {
                _transformScrollDirtyBoundsSuppressionRoot = visual;
            }

            var updatedInPlace = false;
            try
            {
                updatedInPlace = TryUpdateRetainedSubtreeNodesInPlace(
                    visual,
                    renderNodeIndex,
                    parentNode,
                    out var updated);
                if (updatedInPlace &&
                    previous.RenderStateSignature == updated.RenderStateSignature &&
        ...
        private bool CanSafelyDowngradeForcedDeepSync(UIElement root)
        {
            ...
            return !HasDirtyRetainedRenderChildren(root);
        }

        private static bool HasDirtyRetainedRenderChildren(UIElement root)
        {
        ...
        private bool TryRefreshRetainedRenderMetadataBatch(
            IReadOnlyList<KeyValuePair<UIElement, RenderInvalidationKind>> updates)
        {
            if (updates.Count == 0)
            {
                return true;
            ...
            {
                if (!RenderNodeIndices.TryGetValue(updates[i].Key, out var nodeIndex) ||
                    (uint)nodeIndex >= (uint)RetainedRenderList.Count)
                {
                    return false;
                }
            ...
            var refreshAncestors = new bool[RetainedRenderList.Count];
            for (var i = 0; i < updates.Count; i++)
            {
                var nodeIndex = nodeIndices[i];
                var parentIndex = FindRetainedParentIndex(nodeIndex);
                var parentNode = parentIndex >= 0 ? RetainedRenderList[parentIndex] : (RenderNode?)null;
                if (RetainedCompositionLayerBoundary.IsTransformStableLayer(updates[i].Key))
                {
                    RefreshRetainedTransformStableLayerMetadata(nodeIndex, parentNode);
                }
                else
                ...
                MarkRetainedAncestorsForRefresh(parentIndex, refreshAncestors);
            }

            RefreshMarkedRetainedAncestorSubtreeMetadata(refreshAncestors);
            return true;
        }
        ...
        private void MarkRetainedAncestorsForRefresh(int nodeIndex, bool[] refreshAncestors)
        {
            for (var currentIndex = nodeIndex; currentIndex >= 0; currentIndex = FindRetainedParentIndex(currentIndex))
            {
        ...
        private void RefreshMarkedRetainedAncestorSubtreeMetadata(bool[] refreshAncestors)
        {
            for (var currentIndex = RetainedRenderList.Count - 1; currentIndex >= 0; currentIndex--)
            {
                if (!refreshAncestors[currentIndex])
                {
                    continue;
                }
        ...
        internal static bool IsHighCostVisual(UIElement visual)
        {
            return visual is TextBox or TextBlock or Shape;
        }

        internal static bool AreViewportsEqual(Viewport left, Viewport right)
        {
        ...
        internal readonly struct RenderNode
        {
            public RenderNode(
                UIElement visual,
                int traversalOrder,
            ...
            public RenderNode WithSubtreeEndIndex(int subtreeEndIndexExclusive)
            {
                return WithTraversalAndSubtreeEnd(TraversalOrder, subtreeEndIndexExclusive);
            }

            public RenderNode WithTraversalAndSubtreeEnd(int traversalOrder, int subtreeEndIndexExclusive)
            {
                return new RenderNode(
                    Visual,
                    traversalOrder,
        ...
        internal readonly record struct SubtreeMetadata(
            bool HasBoundsSnapshot,
            LayoutRect BoundsSnapshot,
            int VisualCount,
        ...
        internal readonly record struct IndexedDirtyRenderCandidate(
            UIElement Visual,
            int RenderNodeIndex,
            int SubtreeEndIndexExclusive,
            bool RequiresDeepSync,
            bool AllowsSubtreeRebuild);

        internal readonly record struct DirtyRenderWorkItem(
            UIElement Visual,
            int RenderNodeIndex,
            int SubtreeEndIndexExclusive,
            bool RequiresDeepSync,
        ...
        internal readonly record struct DirtyRenderSpan(
            int StartIndex,
            int EndIndexExclusive);

        internal readonly record struct CapturedLocalRenderState(
            bool HasLocalClip,
            LayoutRect LocalClipRect,
            bool HasLocalTransform,
            Matrix LocalTransform,
