...
public partial class RenderSurfaceGpuSubspaceViewport2DView : UserControl, IUiRootUpdateParticipant
{
    ...
    public RenderSurfaceGpuSubspaceViewport2DView()
    {
    ...
    private void EnsureTextures(GraphicsDevice graphicsDevice)
    {
        ...
        var cellSize = _viewModel.CellPixelSize;
        var inset = Math.Max(1, cellSize / 8);
        var roundedRectSize = cellSize - (inset * 2);
        _roundedRect1Texture = CreateRoundedRectTexture(graphicsDevice, roundedRectSize, Math.Min(1, roundedRectSize / 2));
        _roundedRect2Texture = CreateRoundedRectTexture(graphicsDevice, roundedRectSize, Math.Min(2, roundedRectSize / 2));
