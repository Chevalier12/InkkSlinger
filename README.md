...
| Text layout primitives | Shared text layout, wrapping, text rendering integration | `UI/Text/Core/TextLayout.cs`, `UI/Text/Types/TextWrapping.cs`, `UI/Rendering/Text/UiTextRenderer.cs` | Implemented |
